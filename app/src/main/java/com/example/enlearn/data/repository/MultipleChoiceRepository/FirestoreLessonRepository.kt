...
import com.example.enlearn.data.model.MultipleChoiceOject.ChapterData
...
class FirestoreLessonRepository : LessonRepository {
    ...
    override suspend fun getLesson(chapterId: String, lessonId: String): Result<LessonData> {
        return try {
            ...
            val chapter = documentSnapshot.toObject(ChapterData::class.java)
